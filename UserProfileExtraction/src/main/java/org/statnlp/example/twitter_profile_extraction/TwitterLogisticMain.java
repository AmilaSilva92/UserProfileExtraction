...
public class TwitterLogisticMain {
    private static String trainFile="train_corrected.txt";
    private static String testFile="cv_corrected.txt";
...
//        }
        ...
        TwitterInstance[] finalTestInsts;
...
//                    System.out.println(instanceId+"read");
//                }
                inst.toString();
